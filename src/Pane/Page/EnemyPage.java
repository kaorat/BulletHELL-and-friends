...
public class EnemyPage extends GraphicEditor {
    private final ArrayList<UIButton> allButtons = new ArrayList<>(); //0-6 upgrade button 7 go back button
    ...
    private final ArrayList<UISprite> allDropIncrease = new ArrayList<>();
    private final ArrayList<String> descTemplate = new ArrayList<>();
    private final ArrayList<String> increaseTemplate = new ArrayList<>();
    private final ArrayList<ArrayList<Integer>> enemiesPerks;
    private final UISprite partsDrop ;
    private int currentEnemy;
    private final ArrayList<Integer> enemyUnlockCost;
    ...
    public EnemyPage(GraphicsContext graphicsContext) {
        ...
        allIncrease.add((UISprite) create(new UISprite(new Text("", Utility.getGameFont(9), Color.WHITE) ,new Transform(Utility.getGameScreenX() + 310, 230 + moveYButton, 0.25, 0.25), 55)));
        allDropIncrease.add((UISprite) create(new UISprite(new Text("", Utility.getGameFont(9), Color.WHITE) ,new Transform(Utility.getGameScreenX() + 310, 239 + moveYButton, 0.25, 0.25), 55)));
        ...
        //Unlock
        double x = Utility.getGameScreenX();
        ...
        //Init Template
        descTemplate.add("Enemy’s HP : ");
        descTemplate.add("Enemy’s Fire rate : ");
        descTemplate.add("Bullet Speed : ");
        descTemplate.add("Bullet quantity : ");
        descTemplate.add("Bullet length : ");
        descTemplate.add("Chance to obtain soul :  ");
        descTemplate.add("Spawn time :  ");

        increaseTemplate.add("hp");
        increaseTemplate.add("shot/s");
        increaseTemplate.add("m/s");
        increaseTemplate.add("");
        increaseTemplate.add("");
        increaseTemplate.add("%");
        increaseTemplate.add("s");
    }
    @Override
